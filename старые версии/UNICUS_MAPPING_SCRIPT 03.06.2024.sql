...
SELECT
    ...
    CASE
        ...
        CASE
            WHEN TRIM(INN_CODE."Страхователь ИНН") IN ('6671156423', '7722851324', '5190001721') THEN 'B201004'
...
FROM LAST_POLICY LP
    LEFT JOIN STG_UNC.XX_ALFA_RZ_CONTRACT RZ ON RZ.POLICY_UNIQUE_ID_036 = LP.POLICY_UNIQUE_ID_036
        LEFT JOIN INN_CODE ON INN_CODE.SUBJECT_ID = RZ.INSURER_SUBJECT_ID_070
